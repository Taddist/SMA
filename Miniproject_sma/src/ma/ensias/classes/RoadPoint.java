...
public class RoadPoint {
	...
	public RoadPoint() {
		...
		SignalLocList = Arrays.asList(
				new SignalLoc(new Point(305, 600),new Point(305, 518), 1),
		...
		startLocInfoList = Arrays.asList(
				new Point(260, 0), 
				new Point(0, 475), 
				new Point(305, 600),
				new Point(600, 158)
